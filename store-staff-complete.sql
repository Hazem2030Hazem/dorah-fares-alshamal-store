-- ============================================================
-- درة فارس الشمال — نظام دخول الموظفين والمحاسبة (Staff Portal)
-- ملف موحّد كامل (Complete Unified SQL)
--
-- يغطّي:
--   • جداول الموظفين والجلسات والتدقيق
--   • دوال التحقق والصلاحيات
--   • RPCs الأساسية (تسجيل دخول/خروج، طلبات، فواتير، سندات، قيود، مصروفات، رواتب)
--   • الجداول المتقدمة (zatca_log، einvoices، entities، chart_of_accounts، journal، vouchers، expenses، payroll)
--   • RLS + منح الصلاحيات
--
...
--
-- ملاحظة: هذا الملف يحلّ محل store-staff.sql و store-staff-v2.sql
--         ويصلح الغطاء في النسخة التي تبدأ من قسم RPCs مباشرة.
-- ============================================================
