...
var doraChatbot = {
    ...
    getSystemPrompt: function() {
        ...
        context += '\nجاوب بالعربي. خلي إجاباتك مختصرة ومفيدة. استخدم إيموجي بسيط. لو سأل عن حاجة مش متأكد منها، قول له يتواصل مع خدمة العملاء.';
    ...
    getResponse: async function(msg) {
        ...
        // الكلمات المفتاحية السريعة (غير متصلة بالإنترنت)
        var quickReplies = {
        ...
        // Gemini AI
        try {
            var response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-lite:generateContent?key=AIzaSyAb8RN6LDJxeKokRpmkaIFvS8V0tPa1eflqQx1ghmJkdF5ZX4Cg', {
                method: 'POST',
