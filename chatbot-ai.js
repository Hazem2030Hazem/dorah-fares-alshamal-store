...
var doraChatbot = {
    ...
    getResponse: async function(msg) {
        ...
        for (var key in quickReplies) {
            ...
            var self = this;
            var userMsg = msg;
           var response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AQ.Ab8RN6LDJxeKokRpmkaIFvS8V0tPa1eflqQx1ghmJkdF5ZX4Cg', {
                method: 'POST',
