...
(function(){
   // إلغاء تفعيل الروبوت العائم القديم
    ...
    bubble.innerHTML = '<img src="robot.png" alt="مساعد درة فارس" style="width:75px;height:75px">';
